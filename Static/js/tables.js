function highlightRows() {
  ...
  for(i = 1; i < rows.length; i++){
    var estimated = parseFloat(table.rows[i].cells[14].innerHTML);
    var actual = parseFloat(table.rows[i].cells[15].innerHTML);
    var qty = parseInt(table.rows[i].cells[4].innerHTML);
    var qty_comp = parseInt(table.rows[i].cells[5].innerHTML);
